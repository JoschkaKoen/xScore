...
through_step: 1-16 or null. 1=parse, 2=folder, 3=roster, 4=scaffold, 5=blank pages, 6=autorotate,
  7=deskew, 8=detect page anchors, 9=calculate transformation, 10=project bounding boxes,
  11=detect student names, 12=detect questions attempted, 13=mark answers, 14=compile results,
  15=check accuracy, 16=compile report.
