...
from shared.models import Question, flatten_questions
from scaffold.pdf_parser.build import build_questions_from_segments
from scaffold.pdf_parser.config import DEFAULT_PARSER_CONFIG, ParserConfig
from scaffold.pdf_parser.content import (
    ensure_multiple_choice_options_parsed,
    infer_answer_fields,
    normalize_exam_scientific_text,
)
from scaffold.pdf_parser.layout import cell_margin_band, cell_scales
from scaffold.pdf_parser.regions import (
    clip_for_segment,
